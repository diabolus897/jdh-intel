...
> 最后更新：2026-06-26（**v3 呈现改造：竞对卡等高 + 连锁经营档案重构为独立可展开卡片 + 新品区升级为「全球新品雷达」并挂载周报第2期22条；v3.1 微调：经营档案卡展开后等高(align-items:stretch) + 全球新品雷达>3条即滚动(max-height 430px)；v3.2 微调：经营档案折叠卡不被牵连(collapsed→align-self:start) + 直营/加盟行恒渲染 + 门店数据三家两期补全(益丰直营/加盟+大参林26Q1) + 多卡同开时各板块JS横向对齐(alignProfileCards)**）
...
## 5. 当前 data.json 状态（2026-06-25，基础池补全后约 100 条含卡内动态）

| 部门 | 竞对 | 政策 | 工业 | 新品 | 备注 |
|---|---|---|---|---|---|
| nutri 营养保健 | 5 | 3 | 5 | 4 | 618益生菌新锐;护老专项;达能/雀巢并购;汤臣倍健IR;拜耳益生菌泡腾 |
| pharma 医药 | 2卡(阿里健康+美团,各含多条) | 4 | 4 | 1 | 阿里FY26财报;处方药网售合规;礼来/恒瑞EMA/诺华;口服CFB抑制剂 |
| device 医疗器械 | 5 | 3 | 3 | 4 | 雅培双传感CGM/Dexcom儿科+省级二类证;鱼跃接入蚂蚁阿福 |
| consumer 消费器械 | 7 | 5 | 7 | 1 | 医保个账白名单;巨子颈纹植入剂;美瞳增速;锦波高管变动;敷尔佳 |
| instant 即时零售 | 5卡(O2O 2+连锁 3) | 2 | 1(新技术) | 3(行业资本) | 连锁经营速览卡;新石器X6无人车;处方药合规(顶掉原待核) |
| medical 消费医疗 | 5 | 1 | 3 | 3 | 巨子III型颈纹针/753针;爱美客水光;新氧×阿里健康术后包;合规元年 |
