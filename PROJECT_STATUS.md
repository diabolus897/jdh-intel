...
## 5. 当前 data.json 状态（2026-06-25，约 57 条含卡内动态）

| 部门 | 竞对 | 政策 | 工业 | 新品 | 备注 |
|---|---|---|---|---|---|
| nutri 营养保健 | 2 | 2 | 2 | 1 | |
| pharma 医药 | 2卡(阿里健康+美团) | 4 | 5 | 1 | **竞对已卡片化**(美团卡与instant同源);政策三口径;工业按26品牌watchlist |
| device 医疗器械 | 1 | 2 | 1 | **0** | 新品空：窗口内 NMPA 仅介入/临床类，无院外家用器械 |
| consumer 消费器械 | 3 | 3 | 3 | 1 | **业务口径已重订（见下）**，按新品类重抓 |
| instant 即时零售 | 5卡(O2O 2+连锁 3) | 1 | 1(新技术) | 2(行业资本) | **已卡片化**:连锁卡含财报小卡 |
